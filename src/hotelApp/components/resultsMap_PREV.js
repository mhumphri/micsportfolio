...
script.src =
  "https://maps.googleapis.com/maps/api/js?key=AIzaSyAc2bVcp035eZ3dR3LrGjUfrR3pHkgmq68&callback=initialise&libraries=marker,places&v=beta";
 script.async = true;
...
`;
 ...
 zoom: props.onloadSearchRef.current ? false : mapZoom,
  ...
  // listens for calls from "idle" event listener in google map - getter/setter used as closure issue preventing state being accessed inside event listener
